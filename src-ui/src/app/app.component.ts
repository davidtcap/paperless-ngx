    ...
    this.tourService.initialize(
      [
        ...
        },
        {
          ...
          content: $localize`Drag-and-drop documents here to start uploading or place them in the consume folder. You can also drag-and-drop documents anywhere on all other pages of the web app. Once you do, the system will start training its machine learning algorithms.`,
          route: '/dashboard',
        },
        {
        ...
        },
        {
          ...
          content:
            ...
            '<br/><br/>' +
            $localize`Thank you for using Capgemini Document Processing Center!`,
          route: '/dashboard',
          isOptional: false,
          backdropConfig: {
            offset: 0,
